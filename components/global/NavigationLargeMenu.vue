    ...
    <ul class="text-sm flex items-center justify-center">
        ...
        <li class="relative flex items-center justify-center">
            <a
                ...
                class="px-[16px] py-[10px] focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-4 focus-visible:ring-black rounded-lg text-type-on-light-base hover:text-primary-on-light-base hover:underline active:text-primary-on-light-base cursor-pointer"
